    ...
    async function submitLoginForm(e) { // e = in here because control to behavior>"solok" form tage
        ...
        if (validationResult.error) {
            ...
            if (email && password) {
                ...
                localStorage.setItem('UserStatus', 'ExistingUser'); // when login is successful set user token in localStorage in variable userToken
                ...
                setError('user is not found'); // set new error message in error variable when fail register
